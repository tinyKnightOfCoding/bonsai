...
#$PROJECT_ID_TEST = "${PROJECT_ID_PREFIX}-test"
#$PROJECT_NAME_TEST = "${PROJECT_NAME_PREFIX} TEST"
#$PROJECT_ID_PROD = "${PROJECT_ID_PREFIX}-prod"
#$PROJECT_NAME_PROD = "${PROJECT_NAME_PREFIX} PROD"

#Write-Output "Creating dev project"
#
...
#}"
#
#Write-Output "Creating build account DEV"
#
...
#}"
#
#Write-Output "Updating pull rights for compute user"
#
...
#    --name = "deploy-dev" `
#    --service-account = "projects/${PROJECT_ID_MAIN
#}/serviceAccounts/${SA_BUILD_DEV_EMAIL
#}"